...
const MiQR = () => {
  ...
  const { data: cafe } = useCafeteriaBySlug(cafeId || undefined);
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex flex-col gap-3">
              <Button asChild>
                <Link to="/buscar"><Coffee className="h-4 w-4 mr-2" />Explorar cafeterías</Link>
              </Button>
              <Button variant="outline" asChild>
                <Link to="/chat">Buscar con IA</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-6 space-y-3">
            <Button variant="outline" className="w-full" onClick={generateNewQR} disabled={hasQR && expiresIn > 0}>
              <RefreshCw className="h-4 w-4 mr-2" />
              Generar nuevo QR
            </Button>
            <Button variant="ghost" className="w-full" asChild>
              <Link to="/buscar">Ver otras cafeterías</Link>
            </Button>
          </div>
        </div>
      </div>
